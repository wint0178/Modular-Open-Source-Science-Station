...
5. **Flash WOILD v1.1.6 Firmware & Calibrate:** Navigate to [`/software/Landslide Detectors/`](./software/Landslide%20Detectors/), configure your LoRaWAN credentials (`DevEUI`, `AppEUI`, `AppKey`), assign unique node IDs (`NODE_ID`), set static baseline orientation angles, and flash the MCU via Arduino IDE or PlatformIO[cite: 3, 4].
