...
* **The Things Network** Used to connect TTN edge nodes (eg. WOILD Sensors) to your Home Assistant Instance. Setup is addressed in [Chapter 4.3: TTN and LoRa](./ch04-TTN-LoRa.md).
