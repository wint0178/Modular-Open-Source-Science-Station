...
### Step 1: Configure the Home Assistant Gateway
...
### Step 2: Map Inputs to Your Meteorological Sensors
...
### Step 3: Flash the WOILD Hardware Nodes
...
### Step 4: Deploy the TTN / ChirpStack Payload Decoder
1. Navigate to `./Landslide-Detectors/`.
...
### Step 5: Provision Your Remote ESP32/ESPHome Devices (Optional)
